...
export const UserActions: React.FC<UserActionsProps> = ({ user, onLogout, onLoadBook, onDeleteBook, loading }) => {
    ...
    useEffect(() => {
        const fetchBooks = async () => {
            ...
            const books = await bookService.getBooksForUser(user.email);
            setSavedBooks(books);
            setIsLoadingBooks(false);
        };
        fetchBooks();
    }, [user.email, loading]); // Refetch when a global loading action finishes
